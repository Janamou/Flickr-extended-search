...
metadatům.</p>
			...
			<div id="col" class="noprint">
	       		<div id="col-in">
		        	...
		        	<div id="about-me">
		            	<p><strong>Email: </strong><a href="mailto:moudrjan@fit.cvut.cz">janamou@fit.cvut.cz</a><br />
		            	FIT ČVUT</p>
		          	</div>
		          	<h3><span>Aneta Svobodová</span></h3>
		          	<div id="about-me">
		            	<p><strong>Email: </strong><a href="mailto:svoboane@fit.cvut.cz">svoboane@fit.cvut.cz</a><br />
		            	FIT ČVUT</p>
		          	</div>	          		          		          			          
		          	<hr class="noscreen" />
